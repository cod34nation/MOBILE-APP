package com.example.afrizal.alim_crud;
...
public class MainActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    List<data_biodata> itemList = new ArrayList<data_biodata>();
    Adapter adapter;
    int success;
    ...
    private static String url_select     = koneksi.URL + "select.php";
    private static String url_insert     = koneksi.URL + "insert.php";
    private static String url_edit       = koneksi.URL + "edit.php";
    private static String url_update     = koneksi.URL + "update.php";
    private static String url_delete     = koneksi.URL + "delete.php";
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        data_biodata item = new data_biodata();
